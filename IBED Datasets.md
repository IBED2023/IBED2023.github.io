...
| ---------------------------------------------------------- | ----------------------------------- | ------------- | --------------- | ------ | ------ | ----- |
| Europe (Northern Region) & New Zealand                     | Carbon emissions                    | $C$           | $\text{MtCO}_2$ | 761.7  | 756.5  | 527.7 |
| Europe (Northern Region) & New Zealand                     | Share of residential space heating  | $C_{RSH}$     | $\%$            | 51.9%  | 52.8%  | 52.8% |
| Europe (Northern Region) & New Zealand                     | Share of residential space cooling  | $C_{RSC}$     | $\%$            | 2.6%   | 2.3%   | 2.4%  |
| Europe (Northern Region) & New Zealand                     | Share of other end uses             | $C_{RA}$      | $\%$            | 45.4%  | 44.8%  | 44.8% |
| Europe (Transition Region)                                 | Carbon emissions                    | $C$           | $\text{MtCO}_2$ | 235.9  | 220.7  | 161.2 |
| Europe (Transition Region)                                 | Share of residential space heating  | $C_{RSH}$     | $\%$            | 52.5%  | 52.9%  | 50.4% |
| Europe (Transition Region)                                 | Share of residential space cooling  | $C_{RSC}$     | $\%$            | 1.8%   | 2.1%   | 3.0%  |
| Europe (Transition Region)                                 | Share of other end uses             | $C_{RA}$      | $\%$            | 45.8%  | 44.9%  | 46.7% |
| Europe (Southern Region)                                   | Carbon emissions                    | $C$           | $\text{MtCO}_2$ | 92.0   | 108.9  | 113.3 |
| Europe (Southern Region)                                   | Share of residential space heating  | $C_{RSH}$     | $\%$            | 31.8%  | 32.2%  | 35.1% |
| Europe (Southern Region)                                   | Share of residential space cooling  | $C_{RSC}$     | $\%$            | 0.6%   | 0.8%   | 0.8%  |
| Europe (Southern Region)                                   | Share of other end uses             | $C_{RA}$      | $\%$            | 67.7%  | 66.9%  | 64.1% |
| South America (Northern Region: Brazil, Colombia)          | Carbon emissions                    | $C$           | $\text{MtCO}_2$ | 31.2   | 36.7   | 44.3  |
| South America (Northern Region: Brazil, Colombia)          | Share of residential space heating  | $C_{RSH}$     | $\%$            | 3.2%   | 4.0%   | 3.5%  |
| South America (Northern Region: Brazil, Colombia)          | Share of residential space cooling  | $C_{RSC}$     | $\%$            | 3.2%   | 9.1%   | 11.6% |
| South America (Northern Region: Brazil, Colombia)          | Share of other end uses             | $C_{RA}$      | $\%$            | 93.6%  | 86.9%  | 84.9% |
| South America (Southern Region: Argentina, Chile, Uruguay) | Carbon emissions                    | $C$           | $\text{MtCO}_2$ | 32.0   | 45.8   | 58.1  |
| South America (Southern Region: Argentina, Chile, Uruguay) | Share of residential space  heating | $C_{RSH}$     | $\%$            | 30.9%  | 29.7%  | 28.6% |
| South America (Southern Region: Argentina, Chile, Uruguay) | Share of residential space  cooling | $C_{RSC}$     | $\%$            | 3.1%   | 4.7%   | 8.4%  |
| South America (Southern Region: Argentina, Chile, Uruguay) | Share of other end uses             | $C_{RA}$      | $\%$            | 66.0%  | 65.5%  | 63.0% |
...
| United States                                              | Carbon emissions                    | $C$           | $\text{MtCO}_2$ | 1209.3 | 1193.9 | 902   |
...
| Regions                                                    | Name                                | Abbreviations | Unit                     | 2000    | 2010    | 2020    |
| ---------------------------------------------------------- | ----------------------------------- | ------------- | ------------------------ | ------- | ------- | ------- |
| Europe (Northern Region) & New Zealand                     | Energy consumption                  | $E$           | Peta joule $(\text{PJ})$ | 10132.4 | 10897.8 | 9346.9  |
| Europe (Northern Region) & New Zealand                     | Share of residential space heating  | $E_{RSH}$     | $\%$                     | 62.3%   | 62.6%   | 58.6%   |
| Europe (Northern Region) & New Zealand                     | Share of residential space cooling  | $E_{RSC}$     | $\%$                     | 2.5%    | 2.4%    | 2.3%    |
| Europe (Northern Region) & New Zealand                     | Share of other end uses             | $E_{RA}$      | $\%$                     | 35.2%   | 35.0%   | 39.1%   |
| Europe (Transition Region)                                 | Energy consumption                  | $E$           | Peta joule $(\text{PJ})$ | 3579.7  | 4036.5  | 3483.7  |
| Europe (Transition Region)                                 | Share of residential space heating  | $E_{RSH}$     | $\%$                     | 65.4%   | 64.5%   | 57.9%   |
| Europe (Transition Region)                                 | Share of residential space cooling  | $E_{RSC}$     | $\%$                     | 0.9%    | 1.2%    | 1.9%    |
| Europe (Transition Region)                                 | Share of other end uses             | $E_{RA}$      | $\%$                     | 33.7%   | 34.3%   | 40.2%   |
| Europe (Southern Region)                                   | Energy consumption                  | $E$           | Peta joule $(\text{PJ})$ | 1335.4  | 1629.9  | 1748.7  |
| Europe (Southern Region)                                   | Share of residential space heating  | $E_{RSH}$     | $\%$                     | 54.1%   | 48.1%   | 48.5%   |
| Europe (Southern Region)                                   | Share of residential space cooling  | $E_{RSC}$     | $\%$                     | 0.2%    | 0.6%    | 0.6%    |
| Europe (Southern Region)                                   | Share of other end uses             | $E_{RA}$      | $\%$                     | 45.7%   | 51.4%   | 50.9%   |
| South America (Northern Region: Brazil, Colombia)          | Energy consumption                  | $E$           | Peta joule $(\text{PJ})$ | 1042.3  | 1192.3  | 1424.7  |
| South America (Northern Region: Brazil, Colombia)          | Share of residential space heating  | $E_{RSH}$     | $\%$                     | 2.8%    | 2.9%    | 3.1%    |
| South America (Northern Region: Brazil, Colombia)          | Share of residential space cooling  | $E_{RSC}$     | $\%$                     | 5.3%    | 8.6%    | 11.5%   |
| South America (Northern Region: Brazil, Colombia)          | Share of other end uses             | $E_{RA}$      | $\%$                     | 91.9%   | 88.5%   | 85.3%   |
| South America (Southern Region: Argentina, Chile, Uruguay) | Energy consumption                  | $E$           | Peta joule $(\text{PJ})$ | 626.2   | 809.5   | 901.5   |
| South America (Southern Region: Argentina, Chile, Uruguay) | Share of residential space heating  | $E_{RSH}$     | $\%$                     | 30.9%   | 32.1%   | 33.6%   |
| South America (Southern Region: Argentina, Chile, Uruguay) | Share of residential space cooling  | $E_{RSC}$     | $\%$                     | 5.8%    | 5.7%    | 6.9%    |
| South America (Southern Region: Argentina, Chile, Uruguay) | Share of other end uses             | $E_{RA}$      | $\%$                     | 63.3%   | 62.2%   | 59.5%   |
...
| United States                                              | Energy consumption                  | $E$           | Peta joule $(\text{PJ})$ | 10942.2 | 11560.3 | 11499   |
...
| Regions                                                    | Name                   | Abbreviations | Unit                   | 2000   | 2010   | 2020   |
| ---------------------------------------------------------- | ---------------------- | ------------- | ---------------------- | ------ | ------ | ------ |
| Europe (Northern Region) & New Zealand                     | Population size        | $P$           | Million  persons       | 380.6  | 381.8  | 389.2  |
| Europe (Northern Region) & New Zealand                     | Average household size | $p$           | persons  per household | 2.5    | 2.4    | 2.2    |
| Europe (Transition Region)                                 | Population size        | $P$           | Million  persons       | 165.8  | 173.3  | 175.8  |
| Europe (Transition Region)                                 | Average household size | $p$           | persons  per household | 2.6    | 2.5    | 2.5    |
| Europe (Southern Region)                                   | Population size        | $P$           | Million  persons       | 112.9  | 127.4  | 139.8  |
| Europe (Southern Region)                                   | Average household size | $p$           | persons  per household | 4.0    | 3.6    | 3.3    |
| South America (Northern Region: Brazil, Colombia)          | Population size        | $P$           | Million  persons       | 214.4  | 240.9  | 263.4  |
| South America (Northern Region: Brazil, Colombia)          | Average household size | $p$           | persons  per household | 4.8    | 4.3    | 3.7    |
| South America (Southern Region: Argentina, Chile, Uruguay) | Population size        | $P$           | Million  persons       | 55.5   | 61.2   | 68.0   |
| South America (Southern Region: Argentina, Chile, Uruguay) | Average household size | $p$           | persons  per household | 3.5    | 3.3    | 3.2    |
...
| Canada                                                     | Population size        | $P$           | Million persons        | 30.7   | 34     | 36.7   |
| Canada                                                     | Average household size | $p$           | persons per household  | 3      | 2.9    | 2.8    |
...
<script type="text/javascript" src="//rf.revolvermaps.com/0/0/4.js?i=5vnbozco0jv&amp;m=0&amp;h=256&amp;c=ff0000&amp;r=0" async="async"></script>
